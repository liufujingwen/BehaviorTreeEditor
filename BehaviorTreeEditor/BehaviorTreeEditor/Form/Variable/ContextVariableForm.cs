...
{
    public partial class ContextVariableForm : Form
    {
        private VariableDesigner m_EditContextVariable;
        private VariableDesigner m_ContextVariable;
        ...
        private void ContextVariableForm_Load(object sender, EventArgs e)
        {
            Exec("Refresh");
        }
        ...
        private void Swap(bool up)
        {
            ...
            if (up)
            {
                ...
                VariableFieldDesigner preVariable = m_EditContextVariable.VariableFields[preIdx];
                VariableFieldDesigner selectedVariable = m_EditContextVariable.VariableFields[selectIdx];

                m_EditContextVariable.VariableFields[preIdx] = selectedVariable;
                m_EditContextVariable.VariableFields[selectIdx] = preVariable;
            ...
            else
            {
                ...
                VariableFieldDesigner preVariable = m_EditContextVariable.VariableFields[nextIdx];
                VariableFieldDesigner selectedVariable = m_EditContextVariable.VariableFields[selectIdx];

                m_EditContextVariable.VariableFields[nextIdx] = selectedVariable;
                m_EditContextVariable.VariableFields[selectIdx] = preVariable;
